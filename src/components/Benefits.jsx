...
const BENEFITS = [
  {
    ...
    detail: 'Tu negocio aparece donde tu cliente ya está buscando.',
  },
  {
    id: '02',
    text: 'Vender cuando el local está cerrado',
    detail: 'El sistema trabaja 24/7. Vos no tenés que estar.',
  },
  {
    id: '03',
    text: 'Flujo de consultas constante',
    detail: 'Nada de meses buenos y meses muertos. Consistencia.',
  },
  {
    id: '04',
    text: 'Dejar de depender del boca a boca',
    detail: 'Crecé sin esperar que alguien te recomiende.',
  },
];
            ...
            {BENEFITS.map((b) => (
              <li key={b.id} className="bn-item">
                <div className="bn-item__left">
                  <span className="bn-item__num" aria-hidden="true">{b.id}</span>
